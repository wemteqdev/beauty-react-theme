            ...
            <div className = "code-conduct">
                <div className = "code-conduct-block">
                    ...
                    <div className = "row">
                        ...
                        <div className = "col-sm-12 col-md-12 code-blog">
                            <div className = "mb-4" style = {{height:'304px', background:`url(${assets.testbanner})`}}/>
                        ...
                        <div className = "col-sm-12 col-md-4 code-blog">
                            <div className = "mb-3" style = {{height:'152px', background:`url(${assets.storyL_1})`}}/>
                        ...
                        <div className = "col-sm-12 col-md-8 code-blog">
                            <div className = "mb-3" style = {{height:'152px', background:`url(${assets.storyLL_2})`}}/>
                        ...
                        <div className = "col-sm-12 col-md-6 code-blog">
                            <div className = "mb-3" style = {{height:'152px', background:`url(${assets.storyLL_3})`}}/>
...
to them and how you will make things better for them.
                        ...
                        <div className = "col-sm-12 col-md-4 code-blog">
                            <div className = "mb-3" style = {{height:'152px', background:`url(${assets.storyP_2})`}}/>
