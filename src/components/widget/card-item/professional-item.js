...
class ProfessinalItem extends React.Component {
    ...
    renderFriends(cardinfo){
        ...
        return (
            <div className = "friends-container">
                ...
                <img className = "follow" src = {(cardinfo.following)?assets.follow:""}/>
            </div>
        )
    }
        ...
        return (
                <div className = "card-container">
                    ...
                    <div className = "title-container">
                        ...
                        <img className = "verified" src = {(cardinfo.verified)?assets.verifiedgreen:""}/>
                    </div>
