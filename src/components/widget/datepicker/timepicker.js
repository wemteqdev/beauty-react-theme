    ...
    render() {  
        ...
        return (
            <div className = {visibleClass}>
                ...
                <ReactSlider className = "timepicker-slider" withBars = {true} barClassName = 'track' onChange = {this.onChangeHours} min = {0} max = {24} step = {1} value = {parseInt(this.state.hour)}>
                ...
                <ReactSlider className = "timepicker-slider" withBars = {true} barClassName = 'track' onChange = {this.onChangeMins} min = {0} max = {60} step = {1} value = {parseInt(this.state.min)}>
                    <div className="time-picker-handler"></div>
                </ReactSlider>
            </div>
        )
            ...
            <OutSideEvent onOutClick = {this.handleOutClickTimePicker}>  
                <div className = "ola-time-picker">
                    <div className = "time-picker-trigger" onClick = {this.show}>
                        {timestring}
                        <img className = "icon-calcendar" src = {asset.clock_m}/>
                    </div>
