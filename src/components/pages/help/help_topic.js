    ...
    render(){
        return (
            <div className = "help-topic container">
                ...
                <div className = "help-topic-wrapper row">
                    <div className = "help-topic-menu col-lg-4 col-md-6 col-sm-12">
                        <div className = "title">Help Topics</div>
                        <TreeMenu menu = {dummyData.topicmenu}/>
                    </div>
                    <div className = "help-topic-content col-lg-8 col-md-6 col-sm-12">
