        ...
        return (
            <div  className="month-header">
                ...
                <div className = "arrow-group">
                    <span className  = {`back-btn ${iclassname}`} onClick = {this.moveBackward}>
                        <i className = 'arrow up' onClick = {this.moveBackward}></i>
                    </span>
                    <span className  = {`forward-btn ${iclassname}`} onClick = {this.moveForward}>
            ...
            <OutSideEvent onOutClick = {this.handleOutClickSearchBar}>
                <div className = "ardp-date-picker">
                    <div className = "date-picker-trigger"  readOnly= 'true' onClick = {this.show}>
                        {selected}
                        <img alt="..." className = "icon-calcendar" src = {asset.calendar_s}/>
                    </div>
